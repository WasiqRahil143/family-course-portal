# Train With Rahil Portal

Before changing this project, read [PROJECT_CONTEXT.md](./PROJECT_CONTEXT.md). Update it in the same commit whenever a meaningful feature, decision, integration, limitation, or roadmap item changes.

## Legacy starter notes
